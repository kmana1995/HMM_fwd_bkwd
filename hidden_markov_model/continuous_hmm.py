...
class HiddenMarkovModel:
    ...
    def __init__(self, timeseries, n_states, scale_value):
        ...
        Args:
            ...
            prices = dataframe, endogenous variable and Date of timeseries
    ...
    def fit_values(self, observation_probabilities, transition_matrix, state_features):
        ...
        Returns:
            - predictions = list, the fitted predictions
        """
        fitted_values = [0]
    ...
    def run_viterbi_algorithm(self, state_features, transition_matrix):
        ...
        Returns:
            - state_list: the MAP hidden state as defined by the viterbi algorithm
        """
    ...
    def run_baum_welch_algorithm(self):
        ...
        for i in range(10):    
            ...
            backward_probabilities, backward_trellis = self.run_backward_pass(transition_matrix, observation_probabilities)
            ...
            for state in range(self.n_states):
                ...
                for obs in range(len(self.timeseries)):
                    ...
                    state_var += _lambda[obs][state]*np.sqrt((self.timeseries[obs]-state_features.loc[state_features['STATE'] == state, 'MU'])**2)
    ...
    def run_backward_pass(self, transition_matrix, observation_probabilities):
        ...
        for i in range(2,len(observation_probabilities)+1):
            ...
            # Re-evaluate beta (probability of being in state i)
    ...
    def create_initial_state_features(self):
        ...
        initial_state_features = pd.DataFrame({'STATE': state_list, 'MU': mu_list,'SIGMA': sum(sigma_list)/len(sigma_list)})
    ...
    def create_observation_probabilities(self, state_features):
        ...
        Args:
            - prices: dataframe/array, a timeseries of returns for a given stock
            - state_features: dataframe/array, containing the parameter set of a given state-space
        Returns:
            - observation_probabilities: dataframe, containing the probability of our observations from a given state0
        """
